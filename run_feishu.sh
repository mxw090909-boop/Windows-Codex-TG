...
export FEISHU_STREAM_ENABLED=1
export FEISHU_STREAM_EDIT_INTERVAL_MS=400
export FEISHU_STREAM_MIN_DELTA_CHARS=12
export FEISHU_THINKING_STATUS_INTERVAL_MS=900
export FEISHU_IGNORE_OLD_MESSAGE_SECONDS=180
